        ...
        <form @submit.prevent="submit">
            ...
            <div class="mt-4">
                ...
                <div class="mt-1 flex items-center gap-2">
                    <TextInput id="phone" type="tel" class="block flex-1" v-model="form.phone" required
                        autocomplete="tel" />

                    <button type="button"
                        class="inline-flex items-center justify-center px-3 py-2 border border-gray-300 rounded-md bg-white hover:bg-gray-50"
                        :disabled="verifying || verified" @click="verifyPhone" aria-label="Verify phone">
                        <template v-if="verifying">
                            <svg class="animate-spin h-5 w-5 text-gray-700" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="mt-4">
                ...
                <TextInput id="email" type="email" class="mt-1 block w-full" v-model="form.email"
                    autocomplete="username" :disabled="!verified" />
            ...
            <div class="mt-4">
                ...
                <TextInput id="password" type="password" class="mt-1 block w-full" v-model="form.password" required
                    autocomplete="new-password" :disabled="!verified" />
            ...
            <div class="mt-4">
                ...
                <TextInput id="password_confirmation" type="password" class="mt-1 block w-full"
                    v-model="form.password_confirmation" required autocomplete="new-password" :disabled="!verified" />
